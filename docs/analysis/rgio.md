...
- [ ] `parser`, `registry`, `converter`, `formatter` 모듈 분리 (G-01)
- [ ] 새 단위를 registry 추가만으로 확장 가능 (G-02)
- [ ] 변환 계수 단일 정의 (G-03)
- [ ] TC-01 ~ TC-10 전부 통과 (G-05)
- [ ] RTM R-01 ~ R-12 매핑 완료
...
1. **Activity 2** — P0 요구사항(R-01~R-12) 구현, 모듈 구조 생성
2. **Activity 3** — TC-01~TC-10 작성, RTM 갱신
3. **Activity 4** — P1 요구사항(R-13~R-15) 구현, TC-11~TC-14 추가
